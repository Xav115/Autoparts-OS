...
public class Mitsubitshi extends JFrame 
{
	private JPanel contentPane;
	private Mitsubitshi_Data MitsubishiData = new Mitsubitshi_Data();
	...
	public Mitsubitshi() {
		...
		cbBoxModelo.setModel(new DefaultComboBoxModel(new String[] {"", "Eclipce", "Lancer", "Evolution", "Outlander", "Montero"}));
		...
		btnEnterButton.addActionListener(new ActionListener() {
			...
			{	
				...
				{
					JOptionPane.showMessageDialog(null, "You have exceeded the amount availble!");
				}	
				
				p.needResupply(cantidadPm);
				p.needResupply(cantidadPa);
				p.needResupply(cantidadPe);
				dispose();
			}
		});
	...
	{
		String Mc = "Mitubitshi " + " " + Modelo + " " + Ano + "\n"; 
