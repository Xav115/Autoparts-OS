...
public class Mazda extends JFrame 
{
	...
	private Mazda_Data MazdaData = new Mazda_Data();
	...
	public Mazda() {
		...
		cbBoxModelo.setModel(new DefaultComboBoxModel(new String[] {"", "Rx-7", "Rx-8", "Mazda 3", "Mazda 6", "Cx-4"}));
