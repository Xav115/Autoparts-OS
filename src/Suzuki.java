...
public class Suzuki extends JFrame 
{
	...
	private Suzuki_Data SuzukiData = new Suzuki_Data();
	...
	public Suzuki() {
		...
		cbBoxModelo.setModel(new DefaultComboBoxModel(new String[] {"", "Swift", "Celerio", "Bleno", "Ignis", "Vitara"}));
