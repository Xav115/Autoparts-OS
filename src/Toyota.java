...
public class Toyota extends JFrame 
{
	...
	private Toyota_Data ToyotaData = new Toyota_Data();
	...
	public Toyota() {
		...
		cbBoxModelo.setModel(new DefaultComboBoxModel(new String[] {"", "Corolla", "Camry", "Yaris", "Tercer", "Prius"}));
...
//				else if(cantidadPm < 35 & cantidadPm > 25 || cantidadPa < 35 & cantidadPa > 25 || cantidadPe < 35 & cantidadPe > 25){
//					ToyotaData.SubstractMotorM(Motor, cantidadPm);
//					ToyotaData.SubstractMotorA(Acc, cantidadPa);
//					ToyotaData.SubstractMotorE(Ext, cantidadPe);
//					JOptionPane.showMessageDialog(null, "The amount of parts are limited for 2 days, contact your suplier!");
//				}
//				else{
//					ToyotaData.SubstractMotorM(Motor, cantidadPm);
//					ToyotaData.SubstractMotorA(Acc, cantidadPa);
